...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute top-40 right-32 w-24 h-24 rounded-full bg-neo-purple/20 blur-xl animate-float"></div>
      <div className="absolute bottom-40 left-32 w-28 h-28 rounded-full bg-neo-cyan/20 blur-xl animate-float"></div>
      <div className="absolute bottom-20 right-20 w-20 h-20 rounded-full bg-neo-pink/20 blur-xl animate-float"></div>
      ...
      <div className="relative z-10 text-center px-4 max-w-7xl mx-auto">
        ...
        <div className="mb-6 animate-fade-in-up">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <div className="flex space-x-2">
              ...
              <div className="w-6 h-6 bg-neo-purple rounded-full shadow-lg glow-secondary animate-pulse"></div>
              <div className="w-6 h-6 bg-neo-emerald rounded-full shadow-lg glow-accent animate-pulse"></div>
            </div>
          </div>
        </div>
        ...
        {/* Subtitle */}
        <h2 className="text-2xl md:text-4xl font-bold mb-6 text-foreground/80 animate-fade-in-up">
          Three Pillars. One Digital Ecosystem.
        </h2>
        
        {/* Three Subdivisions Highlight */}
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8 text-lg animate-fade-in-up">
        ...
        {/* Core Philosophy */}
        <div className="max-w-4xl mx-auto mb-8 animate-fade-in-up flex items-center justify-center">
        ...
        {/* Description */}
        <p className="text-lg md:text-xl text-foreground/60 max-w-3xl mx-auto mb-12 animate-fade-in-up">
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 max-w-4xl mx-auto animate-fade-in-up">
